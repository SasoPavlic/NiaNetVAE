    ...
    def get_entries(self, hash_id, dataset_name):
        ...
        try:
            with sqlite3.connect(self.db_file, timeout=10) as conn:
                ...
                return pd.read_sql_query(query, conn, params=(hash_id, dataset_name))
        except Exception as e:
    ...
    def get_maximum_fitness(self):
        ...
        try:
            with sqlite3.connect(self.db_file, timeout=10) as conn:
                ...
                max_fitness = pd.read_sql_query(query, conn).iloc[0]['max_fitness']
                return max_fitness
        except Exception as e:
    ...
    def best_results(self):
        ...
        try:
            with sqlite3.connect(self.db_file, timeout=10) as conn:
                ...
                best_results = pd.read_sql_query(query, conn)
